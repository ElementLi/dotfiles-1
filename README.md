...
```bash
git clone https://github.com/ElementLi/dotfiles-1.git && cd dotfiles && source bootstrap.sh
```
...
```bash
cd; curl -#L https://github.com/ElementLi/dotfiles-1/tarball/master | tar -xzv --strip-components 1 --exclude={README.md,bootstrap.sh,.osx,LICENSE-MIT.txt}
```
